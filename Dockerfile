...
# Install CPU-only PyTorch first to prevent CUDA variant being pulled by sentence-transformers
...
# Copy application code (cache bust: 2026-02-11-v3.4.0-parallel-scan-ocr)
COPY VERSION .
COPY database.py .
COPY app.py .
